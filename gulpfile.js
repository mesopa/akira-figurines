...
const theme_name   = 'akira-figurines',
      theme_suffix = '';
...
function concatCssAmp() {
  return src([
       temp + '/compiled-css/' + theme_name + '-vendor-amp.min.css',
       temp + '/compiled-css/' + theme_name + '-styles-amp.min.css',
       temp + '/compiled-css/' + theme_name + '-styles-fonts-amp.min.css'
     ])
...
function inlineCssAmp() {
  var cssContent = fs.readFileSync( temp + '/compiled-css/' + theme_name + '-amp-all.min.css');
...
// -- WATCH          --
function watchFiles() {
  watch( source + '/html/*', series(sassStyles, vendorCss, inlineCss, sassAmp, vendorCssAmp, concatCssAmp, inlineCssAmp) );
  watch( source + '/javascript/*', series(js, vendorJs, concatJs) );
  watch( source + '/scss/*', series(sassStyles, vendorCss, inlineCss, sassAmp, vendorCssAmp, concatCssAmp, inlineCssAmp));
};
